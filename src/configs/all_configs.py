...
class ModelFcosPretrainedConfig:
    ...
    backbone_learning_rate: Annotated[
        Optional[float], Parameter(name="--backbone_lr")
    ] = 8e-3
    step_size: int = 3
...
class DataModuleConfig:
    ...
    train_num_generations: Annotated[int, Parameter(name="--train_num_gen")] = (
        3500  # 100*35
    )
    image_val_folder: Annotated[Optional[str], Parameter(name="--val_folder")] = None
    image_train_folder: Annotated[Optional[str], Parameter(name="--train_folder")] = (
        None
    )
...
class DatasetCreationConfig:
    destination_folder: Annotated[Optional[str], Parameter(name="--dest_folder")] = (
        None  # data/image_train/val or data/image_train/train as an example
    )
    background_folder: Annotated[
        Optional[str], Parameter(name="--background_folder")
    ] = None
    ...
    bg_shape: Annotated[Tuple[int, int], Parameter(name="--bg_shape")] = (
        640,
        360,
    )  # width, height
